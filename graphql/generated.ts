...
export type LoginQuery = { __typename?: 'Query', allLogins: Array<{ __typename?: 'LoginRecord', id: string, loginTitle?: string | null, loginIntro?: string | null, _createdAt: string, _publishedAt?: string | null, brandColour?: { __typename?: 'ColorField', alpha: number, blue: number, green: number, hex: string, red: number } | null, brandLogo?: { __typename?: 'FileField', url: string } | null }> };
